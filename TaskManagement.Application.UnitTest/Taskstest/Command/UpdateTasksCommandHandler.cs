...
{
    public class UpdateTasksCommandHandlerTest
    {
        private readonly IMapper _mapper;
        private readonly Mock<IUnitOfWork> _mockRepo;
        private readonly UpdateTasksDto _TaskDto;
        private readonly UpdateTasksCommandHandler _handler;
        public UpdateTasksCommandHandlerTest()
        {
            ...
            _handler = new UpdateTasksCommandHandler(_mockRepo.Object, _mapper);
        ...
        {
            var result = await _handler.Handle(new UpdateTasksCommand() { UpdateTasksDto = _TaskDto }, CancellationToken.None);
            result.ShouldBeOfType<Result<Unit>>();
            result.Success.ShouldBeTrue();

            var Task = await _mockRepo.Object.TasksRepository.Get(_TaskDto.Id);

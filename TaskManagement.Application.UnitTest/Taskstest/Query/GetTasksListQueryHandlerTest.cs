...
namespace TaskManagement.Application.UnitTest.Tasks.Queries
{
    public class GetTaskListQueryHandlerTest
    {
        ...
        private readonly GetTasksListQueryHandler _handler;
        public GetTaskListQueryHandlerTest()
        {
            ...
            _handler = new GetTasksListQueryHandler(_mockRepo.Object, _mapper);
        ...
        {
            var result = await _handler.Handle(new GetTasksListQuery(), CancellationToken.None);
            result.ShouldBeOfType<Result<List<TasksDto>>>();
